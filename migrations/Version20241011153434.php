 ...
 */
final class Version20241011153434 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE PRODUIT ADD codeprod NVARCHAR(5)  NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP COLUMN codeprod');
